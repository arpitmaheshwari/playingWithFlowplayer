...
(function (e) {
    ...
    var t = !0, n = !1, r = "onreadystatechange", i = "DOMContentLoaded", s = "__IE8__" + Math.random(), o = e.Object,
        u = o.defineProperty || function (e, t, n) {
            e[t] = n.value
        }, a = o.defineProperties || function (t, n) {
            for (var r in n) if (l.call(n, r)) try {
                u(t, r, n[r])
            } catch (i) {
                e.console && console.log(r + " failed on object:", t, i.message)
            }
        }, f = o.getOwnPropertyDescriptor, l = o.prototype.hasOwnProperty, c = e.Element.prototype, h = e.Text.prototype,
        p = /^[a-z]+$/, d = /loaded|complete/, v = {}, m = document.createElement("div");
    b(e.HTMLCommentElement.prototype, c, "nodeValue"), b(e.HTMLScriptElement.prototype, null, "text"), b(h, null, "nodeValue"), b(e.HTMLTitleElement.prototype, null, "text"), u(e.HTMLStyleElement.prototype, "textContent", function (e) {
        ...
        addEventListener: {
            value: function (e, t, n) {
                var r = this, i = "on" + e, o = r[s] || u(r, s, {value: {}})[s], a = o[i] || (o[i] = {}),
                    f = a.h || (a.h = []), c;
                if (!l.call(a, "w")) {
                    a.w = function (e) {
                        return e[s] || g(r, C(r, e), f, !1)
                    };
                    if (!l.call(v, i)) if (p.test(e)) try {
        ...
        dispatchEvent: {
            value: function (e) {
                var t = this, n = "on" + e.type, r = t[s], i = r && r[n], o = !!i, u;
                return e.target || (e.target = t), o ? i.n ? t.fireEvent(n, e) : g(t, e, i.h, !0) : (u = t.parentNode) ? u.dispatchEvent(e) : !0, !e.defaultPrevented
            }
        },
        removeEventListener: {
            value: function (e, t, n) {
                var r = this, i = "on" + e, o = r[s], u = o && o[i], a = u && u.h, f = a ? E(a, t) : -1;
                -1 < f && a.splice(f, 1)
            }
        }
    }), a(h, {
        addEventListener: {value: c.addEventListener},
        dispatchEvent: {value: c.dispatchEvent},
        removeEventListener: {value: c.removeEventListener}
        ...
        addEventListener: {
            ...
            value: function (e) {
                var t = this, n = "on" + e.type, r = t[s], i = r && r[n], o = !!i;
        ...
        getComputedStyle: {
            value: function () {
                ...
                var e = /^(?:[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|))(?!px)[a-z%]+$/, t = /^(top|right|bottom|left)$/,
                    n = /\-([a-z])/g, r = function (e, t) {
            ...
            value: function (t, n, r) {
                var i = "on" + t, u = (e[i] || o)[s], a = u ? E(u, n) : -1;
                -1 < a && u.splice(a, 1)
            }
        }
    })
    ...
    return (function e(t, n, r) {
        ...
        1: [function (_dereq_, module, exports) {
            ...
            common.find = function (query, ctx) {
                ...
                ctx = ctx || document;
                return Array.prototype.map.call(ctx.querySelectorAll(query), function (el) {
                    return el;
                });
            };
...
// from https://github.com/shawnbot/aight
        ...
        }, {"class-list": 33, "computed-style": 34, "punycode": 41}],
...
// Flash is buggy allover
                        ...
                        if (api) {
                            ...
                            player.off('resume.flashhack').on('resume.flashhack', function () {
                                var timer = setTimeout(function () {
                                    ...
                                    player.one('seek.flashhack pause.flashhack load.flashack', function () {
                                        clearTimeout(timer2);
                                    });
                                }, 800);
                                timeouts.push(timer);
        ...
        }, {"../common": 1, "../flowplayer": 28, "./embed": 2, "bean": 31, "extend-object": 36}],
...
// HTML5 --> Flowplayer event
            ...
            var createVideoTag = function (video, autoplay, preload, useCache, inline, subtitles) {
                ...
                if (subtitles && subtitles.length) {
                    ...
                    if (subtitles.some(function (st) {
                            return !common.isSameDomain(st.src);
                        })) common.attr(el, 'crossorigin', 'anonymous');
                    ...
                    load: function (video) {
                        ...
                        if (video.loop || conf.loop) {
                            if (/mpegurl/i.test(video.type)) {
                                player.on('finish.loophack', function () {
                                    player.resume();
                                });
                            }
                    ...
                    Object.keys(EVENTS).forEach(function (type) {
                        ...
                        var l = function (e) {
                            ...
                            if (!player.ready && !/ready|error/.test(flow) || !flow || !common.find('video', root).length) {
                                if (flow === 'resume') player.one('ready', function () {
                                    setTimeout(function () {
                                        triggerEvent();
                                    })
                                });
        ...
        }, {"../common": 1, "../flowplayer": 28, "bean": 31, "extend-object": 36}],
            ...
            flowplayer(function (api, root) {
                api.on('ready', function () {
                    ...
                    el.addEventListener('webkitplaybacktargetavailabilitychanged', function (ev) {
                        ...
                        var trigger = common.createElement('a', {
        ...
        }, {"../common": 1, "../flowplayer": 28, "bean": 31}],
        ...
        }, {"../flowplayer": 28, "./resolve": 19, "bean": 31, "scriptjs": 42}],
        7: [function (_dereq_, module, exports) {
            ...
            flowplayer(function (api, root) {
                ...
                function createUIElements() {
                    ...
                    trigger = common.createElement('a', {
        ...
        }, {"../common": 1, "../flowplayer": 28, "bean": 31, "scriptjs": 42}],
        ...
        }, {"../common": 1, "../flowplayer": 28, "./util/clipboard": 27, "bean": 31}],
...
// esc button
            ...
            flowplayer(function (player, root) {
                ...
                player.on(FS_ENTER, function () {
                    ...
                    if (!FS_SUPPORT && player.engine === "html5") setTimeout(function () {
                        root.css('opacity', oldOpacity);
                    });
                    player.isFullscreen = false;
                ...
                if (!metaKeyPressed && el.ready) {
                    ...
                    switch (key) {
                        ...
                        case 32:
                            ...
                            break;                                      // spacebar
                        case 70:
                            if (conf.fullscreen) el.fullscreen();
   ...
   '));
        ...
        }, {"../common": 1, "../flowplayer": 28, "./ui": 24, "bean": 31}],
        17: [function (_dereq_, module, exports) {
            ...
            flowplayer(function (player, root) {
                ...
                player.play = function (i) {
                    ...
                    if (i === player.video.index) return player.load(arg, function () {
                        player.resume();
                    });
                ...
                if (conf.advance) {
                    player.off("finish.pl").on("finish.pl", function (e, player) {
                        // clip looping
                        if (player.video.loop) return player.seek(0, function () {
                            player.resume();
                        });
        ...
        }, {"../common": 1, "../flowplayer": 28, "./resolve": 19, "bean": 31, "extend-object": 36}],
                ...
                p.loadSubtitles = function (i) {
                    ...
                    common.xhrGet(url, function (txt) {
                        ...
                        entries.forEach(function (entry) {
                            ...
                            if (p.splash) p.one('ready', function () {
                                p.trigger('cuepoint', [p, cue]);
                            });
                        });
                    }, function () {
        ...
        }, {"../flowplayer": 28, "extend-object": 36}],
...
// display seconds in hh:mm:ss format
            ...
            <strong class="fp-speed fp-hidden"></strong>\
                    ...
                    api.on("ready", function (ev, api, video) {
                        ...
                        if (error) {
                            ...
                            common.removeClass(root, 'is-mouseover');
                            api.one('load progress', function () {
                                dismiss();
                            });
                        }
                    ...
                    /* controlbar elements */
                    bean.on(root, 'click', '.fp-volumebtn', function () {
                        api.mute();
                    });
                    bean.on(root, 'click', '.fp-fullscreen', function () {
                        api.fullscreen();
                    });
                    bean.on(root, 'click', '.fp-unload', function () {
                        api.unload();
                    });
        ...
        }, {"../common": 1, "../flowplayer": 28, "./ui/bar-slider": 25, "./ui/slider": 26, "bean": 31, "buffer": 32}],
            ...
            function initializePlayer(element, opts, callback) {
                ...
                var api = {
                    ...
                    load: function (video, callback) {
                        ...
                        if (!engineImpl) return setTimeout(function () {
                            api.trigger("error", [api, {code: flowplayer.support.flashVideo ? 5 : 10}]);
                        }) && api;
         ...
         */
                    ...
                    registerExtension: function (jsUrls, cssUrls) {
                        ...
                        jsUrls.forEach(function (url) {
                            api.extensions.js.push(url);
                        });
                        cssUrls.forEach(function (url) {
                            api.extensions.css.push(url);
                        });
                    }
                ...
                var selectEngine = function (clip) {
                    ...
                    if (conf.enginePreference) engines = flowplayer.engines.filter(function (one) {
...
//Have to add fullscreen last
            ...
            flowplayer(function (e, o) {
                function a(e) {
                    ...
                    return o.href = e, t.hostname(o.hostname)
                }

                var l = function (e, o) {
                        var a = e.className.split(" ");
                        a.indexOf(o) === -1 && (e.className += " " + o)
                    }, n = function (e) {
                        return "none" !== window.getComputedStyle(e).display
                    }, r = e.conf, t = flowplayer.common, i = t.createElement,
                    p = r.swf.indexOf("flowplayer.org") && r.e && o.getAttribute("data-origin"),
                    s = p ? a(p) : t.hostname(), d = (document, r.key);
                if ("file:" == location.protocol && (s = "localhost"), e.load.ed = 1, r.hostname = s, r.origin = p || location.href, p && l(o, "is-embedded"), "string" == typeof d && (d = d.split(/,\s*/)), d && "function" == typeof key_check && key_check(d, s)) {
                    if (r.logo) {
                        var f = t.find(".fp-player", o)[0], c = i("a", {className: "fp-logo"});
                        p && (c.href = p), r.embed && r.embed.popup && (c.target = "_blank");
                        var h = i("img", {src: r.logo});
                        c.appendChild(h), (f || o).appendChild(c)
                    }
                } else {
                    var c = i("a", {href: "https://flowplayer.org/hello"});
                    o.appendChild(c);
                    var y = i("div", {className: "fp-context-menu fp-menu"}, '<strong>&copy; 2017 Flowplayer</strong><a href="https://flowplayer.org/hello">About Flowplayer</a><a href="https://flowplayer.org/license">GPL based license</a>'),
                        g = window.location.href.indexOf("localhost"), f = t.find(".fp-player", o)[0];
                    7 !== g && (f || o).appendChild(y), e.on("pause resume finish unload ready", function (e, a) {
                        var l = -1;
                        if (a.video.src) for (var r = [["org", "flowplayer", "drive"], ["org", "flowplayer", "my"], ["org", "flowplayer", "cdn"]], t = 0; t < r.length && (l = a.video.src.indexOf("://" + r[t].reverse().join(".")), l === -1); t++) ;
                        if (/pause|resume/.test(e.type) && "flash" != a.engine.engineName && 4 != l && 5 != l) {
                            ...
                            for (var p in i) i.hasOwnProperty(p) && (c.style[p] = i[p]);
                            a.load.ed = n(c) && (7 === g || y.parentNode == o || y.parentNode == f), a.load.ed || a.pause()
...
// ================
        ...
        }, {"base64-js": 30, "ieee754": 37, "isarray": 40}],
